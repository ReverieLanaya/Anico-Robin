...
try {
    ...
    echo " mot de passe haché : $user_mdp <br>";

    $req = $bdd->prepare('INSERT INTO user (user_mail, user_name, user_mdp, user_role) VALUES (?,?,?,?)');
    $req->bindParam(1, $user_mail, PDO::PARAM_STR);
    $req->bindParam(2, $user_name, PDO::PARAM_STR);
    $req->bindParam(3, $user_mdp, PDO::PARAM_STR);
    $req->bindParam(4, $user_role, PDO::PARAM_STR);
